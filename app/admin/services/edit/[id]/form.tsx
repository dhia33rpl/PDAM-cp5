...
export default function FormEditService(props: Props) {
  const [name, setName] = useState<string>(props.service.name);
  const [min_usage, setMinUsage] = useState<number>(props.service.min_usage); //inisial value adalah nilai awal
